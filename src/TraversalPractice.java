public class TraversalPractice {
    ...
    public static void printLargeNodesPostOrder(TreeNode node) {
        ...
        if(node.data > 1000) System.out.println(node.data);
    }
    ...
    public static void printOddNodesPreOrder(TreeNode node) {
        ...
        if(node.data % 2 != 0) System.out.println(node.data);
    ...
    public static int sumLeafNodes(TreeNode node) {
        ...
        int leftNode = sumLeafNodes(node.left);

        int rightNode = sumLeafNodes(node.right);
    ...
    public static int size(TreeNode node) {
        ...
        int leftNode = size(node.left);

        int rightNode = size(node.right);
    ...
    public static int branchCount(TreeNode node) {
        ...
        int leftNode = branchCount(node.left);

        int rightNode = branchCount(node.right);
